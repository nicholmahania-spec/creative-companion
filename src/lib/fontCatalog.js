...
export const FONT_FAMILIES = [
  ...
  { id: 'source-serif', name: 'Source Serif 4', google: 'Source+Serif+4' },
  { id: 'plex-mono', name: 'IBM Plex Mono', google: 'IBM+Plex+Mono' },
  // Already in TYPE_PAIRS — keep them resolvable through this registry too.
  { id: 'jakarta', name: 'Plus Jakarta Sans', google: null },
  { id: 'libre-baskerville', name: 'Libre Baskerville', google: 'Libre+Baskerville' },
  { id: 'source-sans', name: 'Source Sans 3', google: 'Source+Sans+3' },
  { id: 'dm-sans', name: 'DM Sans', google: 'DM+Sans' },
  { id: 'lato', name: 'Lato', google: 'Lato' },
  { id: 'system-ui', name: 'System UI', google: null },
]
