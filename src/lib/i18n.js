...
const EN = {
  ...
  ui: {
    ...
    resumeCaptureHint: 'Capture a step on Sketch',
    ...
    decisionEmpty: 'Pick a winner on Ideate — we save why for Sketch.',
    decisionLogged: 'Decision saved · {label}',
    decisionSketchHint: 'Sketch this direction. Low polish.',
    decisionEditIdeate: 'Edit on Ideate',
    kitBuilding: 'Building brand kit…',
    downloadKit: 'Download brand kit (zip)',
    kitHint:
      'PDF + Markdown + tokens.css + tokens.json + logo — client-ready file pack',
    messagingPillars: 'Messaging pillars',
    messagingPromise: 'Promise',
    messagingProof: 'Proof',
    messagingPersonality: 'Personality',
    imageryGuidelines: 'Imagery guidelines',
    imageryStyle: 'Photo / illustration style',
    imageryDo: 'Imagery do',
    imageryDont: 'Imagery don’t',
    logoDonts: 'Logo don’ts',
    logoMinSize: 'Min size',
