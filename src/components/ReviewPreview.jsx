...
const ReviewPreview = memo(({ activeProject, buildCurrentBrandPack, loading = false, error = null }) => {
  // Measure render performance
  return measureTime('ReviewPreview_render', () => {
    // Handle error state
    if (error) {
      return measureTime('ReviewPreview_error', () => (
    ...
    if (loading) {
      return measureTime('ReviewPreview_loading', () => (
        <div className="space-y-4">
          <div className="border rounded-lg p-4">
            <h3 className="font-semibold text-lg mb-2">Review Overview</h3>
            <p className="text-sm text-muted-foreground mb-4">
    ...
    const runTranslate = useCallback(async (line) => {
      setTranslating(true)
      setTranslation(null)
    ...
    // Stats
    const totalNotes = useMemo(() => noteLines.length, [noteLines])

    // Handle empty state
    if ((!activeProject || !feedbackNotes) && !loading && !error) {
      return measureTime('ReviewPreview_empty', () => (
        <div className="space-y-4">
          <div className="border rounded-lg p-4">
            <h3 className="font-semibold text-lg mb-2">Review Overview</h3>
            <p className="text-sm text-muted-foreground mb-4">
    ...
    return measureTime('ReviewPreview_content', () => (
      <div className="space-y-4">
        <div className="border rounded-lg p-4">
          <h3 className="font-semibold text-lg mb-2">Review Overview</h3>
          <p className="text-sm text-muted-foreground mb-4">
