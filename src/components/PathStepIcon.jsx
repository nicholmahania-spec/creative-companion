...
const ICONS = {
  ...
  research: (
    <>
      ...
      <path d="M13.25 13.25 17 17" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
    </>
  ),
  ideate: (
    <path
  ...
  design: (
    <>
      <circle cx="8.5" cy="9" r="2.5" fill="none" stroke="currentColor" strokeWidth="1.75" />
      <circle cx="14.5" cy="9" r="2.5" fill="none" stroke="currentColor" strokeWidth="1.75" />
      <circle cx="11.5" cy="14.5" r="2.5" fill="none" stroke="currentColor" strokeWidth="1.75" />
    </>
  ),
  review: (
    <path
